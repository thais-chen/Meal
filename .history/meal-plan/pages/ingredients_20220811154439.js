...
export default function Ingredients() {
  ...
  function getImg(){
    ...
    fetch(
      "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/food/products/search?query=&maxCalories=5000&minProtein=0&maxProtein=100&minFat=0&maxFat=100&minCarbs=0&maxCarbs=100&minCalories=0&offset=0&number=10",
      options
    )
